...
// #include "SignalExtraction.C"
#include "CORE/SignalExtraction.C"
...
void SysTotSignalExtractionPt(const char *file = fileName2, Float_t minCent = min_cent, Float_t maxCent = max_cent, Efunction fBackgroundv2 = kv2BackgroundPol3, Efunction fSignalv2 = kv2Pol3vsMassCB2Pol2Pol3, Efunction fBackground = kPol2Pol3, Efunction fSignal = kCBExtended, Etails pTails = p_tails)
{
